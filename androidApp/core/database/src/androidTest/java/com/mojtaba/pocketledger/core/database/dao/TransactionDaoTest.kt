...
import com.mojtaba.pocketledger.core.database.testTag
import com.mojtaba.pocketledger.core.database.testTransaction
import com.mojtaba.pocketledger.core.database.testTransactionTagCrossRef
...
class TransactionDaoTest {
    ...
    fun observeById_emitsCreateUpdateDeleteChanges() = runTest {
        ...
        val emissions = mutableListOf<com.mojtaba.pocketledger.core.database.model.TransactionEntity?>()
    ...
    private companion object {
        const val NO_FILTER_PLACEHOLDER = "__pocket_ledger_no_filter__"
    }
}
