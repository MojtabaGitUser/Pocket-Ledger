...
import com.mojtaba.folentra.core.security.applock.AppLockMessage
...
internal fun AppLockScreen(
    ...
    Column(
        modifier = modifier
            ...
            .semantics {
                contentDescription = "Folentra is locked. $lockMessage"
        ...
        if (state.status == AppLockStatus.Authenticating || state.status == AppLockStatus.Loading) {
            ...
            Button(
                ...
                modifier = Modifier.semantics {
                    contentDescription = "Unlock Folentra"
