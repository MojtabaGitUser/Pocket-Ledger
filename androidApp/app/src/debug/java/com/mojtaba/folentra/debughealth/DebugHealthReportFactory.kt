...
import com.mojtaba.folentra.BuildConfig
...
import com.mojtaba.folentra.core.database.DatabaseMigrations
...
import com.mojtaba.folentra.observability.StartupFailureStatus
...
class DebugHealthReportFactory(
    ...
    private fun databaseSection(): DebugHealthSection =
        DebugHealthSection(
            title = "Database",
            statuses = listOf(
                status("Database", FolentraDatabase.DATABASE_NAME, "Local Room database name."),
                status(
                    "Schema version",
    ...
    private fun com.mojtaba.folentra.observability.StartupFailureSnapshot.displayValue(): String =
